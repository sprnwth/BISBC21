report 50033 "Kbank Export FTR"
{
    ...
    dataset
    {
        dataitem("Gen. Journal Batch"; "Gen. Journal Batch")
        {
                ...
                begin
                    ...
                    If "Account Type" = "Account Type"::Vendor then begin
                        ...
                        If "Account Type" = "Account Type"::"Bank Account" then begin
                            BankAccountRepG.Reset();
                            BankAccountRepG.SetRange("No.", "Gen. Journal Line"."Account No.");
                            If BankAccountRepG.FindFirst() then;
                    ...
                    if ("Gen. Journal Batch"."Incl. status") and ("Gen. Journal Batch"."Ebanking Type" = "Gen. Journal Batch"."Ebanking Type"::FTR) then begin
                        ...
                        //Message(VendorBankAccountNameG);
                        FTR_Details("Line No.", "Posting Date", VendorBankAccountNoG, AmountG, VendorBankAccountNameG,
            ...
            begin
                ...
                TestField("Ebanking Type", "Ebanking Type"::FTR);
                ...
                //-------------------- Write Header --------------------
                FTR_Header(BankAccountG."Bank Account No.", TotalAmtHdrG, PostingDate, TotalCreditTermsCountG, ChargeofAC);
                OutStreamExportTextG.WriteText(ValueG);
                OutStreamExportTextG.WriteText;
                //-------------------- Write Header --------------------
    ...
    local procedure FTR_Header(BankAccNo: Code[20]; TotalAmtDeductWHT: Decimal; PostingDate: Date; TotalLine: Integer; ChargeAc: Text[1])
    begin
        Clear(ValueG);
    ...
    local procedure FTR_Details(LineNo: Integer; PostingDate: Date; VendorBankAccNo: Code[20]; PVAmt: Decimal; VendorBankAccountNameG: Text[50]; AdviceMode: Text[1]; FaxNo: Text[50]; Email: Text[50])
    begin
        Clear(ValueG);
    ...
    local procedure FTR_MESSAGEINF()
    begin
        Clear(ValueG);
