report 50023 "Transfer in Report"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultRenderingLayout = LayoutName;
    Caption = 'Transfer in Report';
        ...
        dataitem("Transfer Receipt Header"; "Transfer Receipt Header")
        {
            ...
            dataitem("Transfer Receipt Line"; "Transfer Receipt Line")
            {
                ...
                begin
                    ...
                    ItemLedgerEntriesG.SetRange("Item No.", "Transfer Receipt Line"."Item No.");
                    ItemLedgerEntriesG.SetRange("Document No.", "Transfer Receipt Line"."Document No.");
                    ...
                    //Message('Lot : %1', LotNoG);
                    //Message('Waranty : %1', WarantyDateG);

                    DimensionValueDepartG.Reset();
                    DimensionValueDepartG.SetFilter("Dimension Code", 'DEPARTMENT');
                    DimensionValueDepartG.SetRange(Code, "Transfer Receipt Line"."Shortcut Dimension 1 Code");
                    ...
                    DimensionValueBranchG.SetRange(Code, "Transfer Receipt Line"."Shortcut Dimension 2 Code");
            ...
            begin
                ReasonCodeG.Reset();
                ReasonCodeG.SetRange(Code, "Transfer Receipt Header"."Reason Code");
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Source Code/ReportLayout/ReportTransferIn2.rdlc';
        }
    }
