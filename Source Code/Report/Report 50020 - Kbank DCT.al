report 50020 "Kbank Export DTC"
{
    ...
    dataset
    {
        dataitem("Gen. Journal Batch"; "Gen. Journal Batch")
        {
            ...
            begin
                ...
                TestField("Ebanking Type", "Ebanking Type"::DCT);
                ...
                DCT_Header(BankAccountG."Bank Account No.", TotalAmtHdrG, PostingDate, TotalCreditTermsCountG, ChargeofAC);
                OutStreamExportTextG.WriteText(ValueG);
                OutStreamExportTextG.WriteText;
                //-------------------- Write Header --------------------
    ...
    local procedure DCT_Header(BankAccNo: Code[20]; TotalAmtDeductWHT: Decimal; PostingDate: Date; TotalLine: Integer; ChargeAc: Text[1])
    begin
        Clear(ValueG);
    ...
    local procedure DCT_Details(LineNo: Integer; PostingDate: Date; VendorBankAccNo: Code[20]; PVAmt: Decimal; VendorBankAccountNameG: Text[50]; VATWHTLineCnt: Decimal; DocNo: Code[16]; AdviceMode: Text[1]; FaxNo: Text[50]; Email: Text[50]; AmtBeforeVATWHT: Decimal; TotalVATWHT: Decimal; AmtAfterVATWHT: Decimal)
    begin
        Clear(ValueG);
    ...
    local procedure DCT_MESSAGEINF()
    begin
        Clear(ValueG);
