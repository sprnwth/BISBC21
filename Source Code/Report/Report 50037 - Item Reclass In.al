report 50037 "Item Reclass In"
{
    // UsageCategory = ReportsAndAnalysis;
    // ApplicationArea = All;
    DefaultRenderingLayout = LayoutName;
    Caption = 'Item Reclass Transfer In';
    ...
    dataset
    {
        dataitem("Item Journal Line"; "Item Journal Line")
        {
            ...
            column(Transfer_from_Code; "New Location Code")
            {

            }
            column(Transfer_to_Code; "New Location Code")
            {

            }
            column(Transfer_To_Bin_Code; "New Bin Code")
            {
            ...
            column(Shortcut_Dimension_1_Code; "New Shortcut Dimension 1 Code")
            {

            }
            column(Shortcut_Dimension_2_Code; "New Shortcut Dimension 2 Code")
            {
            ...
            begin
                ...
                if ItemTrackingG.FindFirst() then begin
                    LotNoG := 'Lot No. : ' + ItemTrackingG."New Lot No.";
                    WarantyDateG := 'Mfd dt : ' + Format(ItemTrackingG."Warranty Date") + '   ' + 'Exp dt : ' + Format(ItemTrackingG."New Expiration Date");
                end else begin
                    ReservationG.Reset();
                    ...
                    if ReservationG.FindFirst() then begin
                        ...
                        WarantyDateG := 'Mfd dt : ' + Format(ReservationG."Warranty Date") + '   ' + 'Exp dt : ' + Format(ReservationG."New Expiration Date");
                    end else begin
                        LotNoG := 'Skip';
                        WarantyDateG := 'Skip';
                    end;
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './Source Code/ReportLayout/Item Reclass In.rdlc';
        }
    }
