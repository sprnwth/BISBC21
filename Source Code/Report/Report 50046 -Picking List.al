report 50046 "Picking Report New"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Source Code/ReportLayout/PickingList.rdlc';
        ...
        dataitem("Warehouse Activity Header"; "Warehouse Activity Header")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem(WhseActLine; "Warehouse Activity Line")
                {
                    ...
                    column(UOMCode_WhseActLine; UMONameG)
                    {
                    }
                    ...
                    begin
                        ...
                        UMOG.Reset();
                        UMOG.SetRange(Code, WhseActLine."Unit of Measure Code");
                        if UMOG.FindFirst() then
                            UMONameG := UMOG.Description;
                    end;
