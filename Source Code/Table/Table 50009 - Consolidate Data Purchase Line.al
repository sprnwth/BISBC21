table 50009 "Consolidate Purchase Line"
{
    Caption = 'Consolidate Purchase Line';
    DrillDownPageID = "Consolidate Purchase Lines";
    LookupPageID = "Consolidate Purchase Lines";
    Permissions = TableData "Consolidate Purchase Line" = rimd;
...
#pragma warning restore
    ...
    keys
    {
        key(Key1; CompanyName, "Document Type", "Document No.", "Line No.")
        {
            Clustered = true;
        }
        key(Key2; CompanyName, "Document No.", "Line No.", "Document Type")
        {
            Enabled = false;
        }
      
        key(Key20; CompanyName)
        {
        }
    }
